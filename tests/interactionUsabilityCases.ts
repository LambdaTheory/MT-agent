...
export const interactionUsabilityCases: InteractionCase[] = [
  ...
  },
  {
    id: 'best-r50-20d',
    category: 'query',
    utterance: '近2天数据最好r50是哪个id',
    capabilityExpectation: { description: '按同款组找近2天金额最佳链接', toolName: 'product.rankBestSameSku', arguments: { query: 'r50', periodDays: 2, metric: 'amount' } },
    expectedFailureLayer: 'routing',
    expectedResponseType: 'text',
  },
  {
  ...
  },
  {
    ...
    capabilityExpectation: { description: '生成 R50 定向活跃度刷新计划', toolName: 'operations.refreshActivityPlan', arguments: { query: 'r50', conditions: [{ metric: 'amount', operator: 'eq', value: 0 }], windowDays: 2 } },
    expectedFailureLayer: 'routing',
  ...
  },
  {
    ...
    capabilityExpectation: { description: '生成 Pocket 3 定向活跃度刷新计划', toolName: 'operations.refreshActivityPlan', arguments: { query: 'pocket3', conditions: [{ metric: 'amount', operator: 'eq', value: 0 }], windowDays: 2 } },
    expectedFailureLayer: 'routing',
    expectedResponseType: 'strategy_card',
  },
  {
    ...
    capabilityExpectation: { description: '生成全局活跃度刷新计划', toolName: 'operations.refreshActivityPlan', arguments: { conditions: [{ metric: 'amount', operator: 'eq', value: 0 }], windowDays: 2 } },
  ...
  },
  {
    ...
    capabilityExpectation: { description: '生成只下架策略的刷新计划确认入口', toolName: 'operations.refreshActivityPlan', arguments: { conditions: [{ metric: 'amount', operator: 'eq', value: 0 }], windowDays: 2 } },
    expectedFailureLayer: 'workflow',
    expectedResponseType: 'strategy_card',
  },
  {
    ...
    capabilityExpectation: { description: '生成下架加补链策略的刷新计划确认入口', toolName: 'operations.refreshActivityPlan', arguments: { conditions: [{ metric: 'amount', operator: 'eq', value: 0 }], windowDays: 2 } },
    expectedFailureLayer: 'workflow',
    expectedResponseType: 'strategy_card',
  },
  {
