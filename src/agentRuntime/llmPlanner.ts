        ...
        messages: [
          {
            ...
            content: [
              ...
              'For arbitrary read-only questions about saved public traffic report data that are not product/link/problem-pool/filter questions, use publicTraffic.reportQuery. Map natural language into target, date, period, metrics, filters, sortBy, limit, section, orderPage, and orderIndicator.',
              ...
              'For price-change requests that target SKU/spec names by keyword, such as "所有规格含有日常或者平日的字样", do not use rental.pricePreview for whole-product rent fields. If exact productId, exact specId, and absolute target prices are not available for rental.perSpecPricePlan, ask for clarification or report that keyword-relative per-spec price changes are unsupported.',
