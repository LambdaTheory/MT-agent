        ...
        messages: [
          {
            ...
            content: [
              ...
              'Examples for publicTraffic.reportQuery: "2026-06-22 访问最高的前20个商品" means target products, date 2026-06-22, period 1d unless a 7日/30日 window is mentioned, sortBy publicVisits, limit 20. "7日金额最高的10个商品" means target products, period 7d, sortBy amount, limit 10. "托管异常商品有哪些" means target section, section custodyAbnormal. "各问题池分别多少条" means target sectionCounts. "订单分析里的签约发货率是多少" means target orders, orderPage overview, orderIndicator 签约发货率. "数据源有没有异常" means target dataQuality.',
