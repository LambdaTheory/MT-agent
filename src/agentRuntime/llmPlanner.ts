        ...
        messages: [
          {
            ...
            content: [
              ...
              'For requests to change prices for all products in a named model, alias, product group, or same-SKU group, compose atomic steps: first linkRegistry.resolveProducts with id "resolve" and resolutionMode "sameSkuGroup", then rental.pricePreview with productIds "${resolve.productIds}", discount as a multiplier such as 0.9 for 九折 or 1.8 for 调价1.8/1.8倍, and scope rent_fields. Never include marketPrice, deposit, purchasePrice, costPrice, or finalPayment unless the user explicitly names that exact field.',
