...
export type LinkRegistrySource = 'product_id_mapping' | 'product_name_map' | 'goods_first_seen' | 'goods_link_lifecycle' | 'link_registry_override' | 'short_name_rule' | 'same_sku_group_alias_rule';
