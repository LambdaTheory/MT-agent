...
- Modify: `package.json`
  ...
  - Add script `feishu-bot:sdk`.
- Modify: `package-lock.json`
  - Generated by `npm install @larksuiteoapi/node-sdk`.
- Modify: `.env.example`
...
## Task 1: Add SDK Dependency And Script
...
Expected: PASS. TypeScript does not validate package script targets, so the missing future CLI entrypoint should not affect this build.
