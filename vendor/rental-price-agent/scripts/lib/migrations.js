...
const TASK_STATUSES = new Set(["planned", "running", "in_progress", "completed", "failed", "verify_failed", "cancelled", "stopped", "rolled_back", "rollback_failed", "rollback_verify_failed"]);
